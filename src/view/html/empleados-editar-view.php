        ...
        <div class="col-12 p-3 p-lg-5">
            <div class="row d-flex flex-row justify-content-center align-items-center">
                <div class="col-12 p-5 Quick-title">
                    <h1 class="m-0 p-0">Editar Empleado</h1>
                </div>
                    ...
                    <div class="col-12 Quick-form px-4 rounded-2">
                        <form action="" method="POST" class="form py-3 needs-validation" novalidate>
                            ...
                            <div class="row d-flex flex-row justify-content-center align-items-center">
                                ...
                                <input type="hidden" name="id_email" id="id_email" value="<?php echo $email ?>">
                                ...
                                <div class="col-md-6 d-flex flex-column py-3">
                                    <label for="id_rol" class="form-label Quick-title">Rol del Usuario</label>
                                ...
                                <div class="col-md-6 d-flex flex-column py-3">
                                    ...
                                    <select name="estado_empleado" id="estado_empleado" class="Quick-custom-input">
...
if (
    ...
    include_once "controller/empleados_editar_C.php";
    $resp = empleados_editar_C::editarEmpleado($_POST);

    if (!empty($resp["success"])) {
        echo "<script>alert('Empleado editado exitosamente');</script>";
        echo "<script>window.location.href = 'empleados-listado';</script>";
        exit();
    } else {
        $msg = $resp["error"] ?? "Error desconocido";
        echo "<script>alert('Error al editar el empleado: $msg');</script>";
    }
}

?>

<script type="module" src="api/client/empleados-editar.js"></script>
<script src="view/js/empleados-editar.js"></script>